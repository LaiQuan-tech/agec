...
/**
 * 系友專區 (/alumni) — 風格B 現代簡潔. eyebrow + 900 heading → left-image /
 * right-text intro → 3-col rounded link cards. Cards render real `links` rows
 * (section='alumni').
 */
  ...
  return (
    <ModernShell>
      <div className="page-in mx-auto max-w-[1240px] px-6 py-9 sm:py-14 md:px-11">
        ...
        <h1 className="text-[30px] sm:text-[38px] md:text-[44px]" style={{ fontFamily: SANS, fontWeight: 900, margin: "0 0 40px", letterSpacing: "-.01em", color: "var(--ink)" }}>系友專區</h1>
        ...
        <div className="mb-8 sm:mb-12 grid grid-cols-1 items-center gap-8 sm:gap-12 md:grid-cols-2">
          ...
          <div>
            <h2 style={{ fontFamily: SANS, fontSize: 26, fontWeight: 700, color: "var(--brand-green)", lineHeight: 1.5, margin: "0 0 16px" }}>系友捐贈與系友動態</h2>
